...
public class SampleController {
	...
	public String get3(@RequestParam("id") String id, @RequestParam("pw") String pw, HttpServletRequest request, Model model)throws Exception {
		model.addAttribute("id",id);
		model.addAttribute("pw",pw);
		return "sample/get3";
	}
	...
	public ModelAndView get7(@RequestParam("id") String id, @RequestParam("pw") String pw, HttpServletRequest request, Model model, ModelAndView mav)throws Exception {
		mav.addObject("id", id);
		mav.addObject("pw", pw);
	...
	public String post3(@RequestParam("id") String id, @RequestParam("pw") String pw, HttpServletRequest request, Model model)throws Exception {
		model.addAttribute("id",id);
		model.addAttribute("pw",pw);
		return "sample/post3";
	}
	...
	public ModelAndView post(@RequestParam("id") String id, @RequestParam("pw") String pw, HttpServletRequest request, Model model, ModelAndView mav)throws Exception {
		mav.addObject("id", id);
		mav.addObject("pw", pw);
